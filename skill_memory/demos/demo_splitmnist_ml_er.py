...
class SnapshotEvaluationPlugin(SkillMemoryPlugin):
    ...
    def after_training_exp(self, strategy, **kwargs):
        ...
        self._log(f"Evaluation snapshot {skill}: experience {index}, classes={classes}")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--eval-routing",
        choices=("class_oracle", "probe", "none"),
...
def main() -> None:
    ...
    diagonal_loss = np.array([loss_history[i][i] for i in range(len(loss_history))])
