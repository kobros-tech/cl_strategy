...
def find_best_skill(
    ...
    Selection uses dynamic gap clustering plus an automatically derived
    floor. This function does not perform CLONE because CLONE needs access
    to the actual stored state_dicts and the model/probe evaluator.
    """
